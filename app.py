...
# p_out = open("C:/Users/91830/Incident Impact Prediction Project/Model_xgb.pkl", "rb")
p_out = open(r"C:/Users/Mahesh/Downloads/Model_rf.pkl", "rb")
model = p.load(p_out)
...
def main():
    ...
    img = Image.open(r"C:\Users\Mahesh\Downloads\image.png.jpeg")
    img2 = Image.open(r"C:\Users\Mahesh\Downloads\streamlitlogo.jpg")

    img4 = Image.open(r"C:\Users\Mahesh\Downloads\incidentimg.jpg")
    ...
    st.sidebar.write(
        "After it will go directly to Machine Learning Model and It will Predict the ** Impact of Incident!!**")
